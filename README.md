...
| 2022.01, 2022.08 | 방학 파이썬 기초 스터디 | 운영장 | [LINK](https://www.youtube.com/playlist?list=PL8GZOhO7EQ0_UBm9dOI4yJUKuR3Ym-bej) |
...
|D&A ML session|21.09~21.12|머신러닝|-|
...
| 프로젝트명 | 기간 | 분야 | 링크 |
| :------: | :---: | :---: | :---: |
|L사의 고객 세분화를 통한 프로모션 제안|21.03~21.06|데이터 분석|-|
...
|FineGym dataset Temporal Action Localization through various data|22.12~ ing|CV, Speech|[LINK](https://github.com/Go-MinSeong/Video-of-a-gym-math-Temporal-Action-Localization)|
|KRX시장 신규 상장 주식 주가 흐름 분석|23.03~ ing|데이터 분석, NLP|[LINK](https://github.com/Go-MinSeong/KRX-Market-New-Listing-Stock-Price-Flow-Analysis)|
...
| 프로젝트명 | 주관 | 대회명 | 기간 | 비고 |
| :---: | :---: | :---: | :-----: | :---: |
|잡케어 서비스에 적용 가능한 추천 알고리즘 개발|DACON|잡케어 추천 알고리즘 경진대회 |22.01~22.01|-|
...
|공정 데이터를 활용하여 Radar 센서의 안테나 성능 예측을 위한 AI 모델 개발|LG AI Research|자율주행 센서의 안테나 성능 예측 AI 경진대회|22.08~22.08|-|
...
## 🎮 Game Skills 
![Go턴](https://lol-github-profile-api.vercel.app/api/opgg?name=Go턴&queueType=RANKED_SOLO_5x5)![Akaps](https://lol-github-profile-api.vercel.app/api/opgg?name=Akaps&queueType=RANKED_SOLO_5x5)![hideonbush](https://lol-github-profile-api.vercel.app/api/opgg?name=hideonbush&queueType=RANKED_SOLO_5x5)
